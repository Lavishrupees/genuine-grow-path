...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium investment platform with simulated plans, portfolio tracking and education in stocks, crypto and long-term investing." },
      { property: "og:title", content: "Genuine Investment — Together we succeed" },
      { property: "og:description", content: "Premium investment platform with simulated plans, portfolio tracking and education." },
